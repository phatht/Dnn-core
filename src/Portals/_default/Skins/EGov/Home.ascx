...
<dnn:DnnCssInclude runat="server" FilePath="Css/devextremeCss/dx.softblue.compact.css" PathNameAlias="SkinPath" /> 
...
<div id="siteWrapper" class="LayoutCustom">
    ...
    <!-- Navigation -->
    <nav class="navbar btNavigation">
        <div class="container">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle collapsed pull-right" data-toggle="collapse"
                    aria-expanded="false" data-target="#navbar-content">
