    ...
    var easyWizardMethods = {
        init: function (options) {
            ...
            return this.each(function () {
                ...
                thisSettings.width = $(window).width() * 0.82;
                if (thisSettings.steps > 1) {
                    // Create UI
                    $this.wrapInner('<div class="easyWizardWrapper ' + thisSettings.width + '" />');
                    ...
                    if (thisSettings.showButtons) {
                        ...
                        paginationHtml += thisSettings.submitButton ? '<button type="submit" id="btnCreate" class="submit ' + thisSettings.submitButtonClass + '">' + thisSettings.submitButtonText + '</button>' : '';
                        paginationHtml += '</div>';
            ...
            if ($paginationBloc.length) {
                if (step == 1) {
                    ...
                    switch (step) {
                        case 6:
                            ProviderViewClick();
                            $(document.getElementById('btnPreviewListProvider')).show();
                    ...
                    PayorViewClick();
                    $(document.getElementById('btnPreviewListPayor')).show();
                    $(document.getElementById('btnPreviewListProvider')).hide();
