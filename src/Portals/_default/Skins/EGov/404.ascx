    ...
    <div class="container">
        <main role="main">
            ...
            <div id="breadcrumb" class="col-md-12">
                <dnn:BREADCRUMB ID="dnnBreadcrumb" runat="server" CssClass="breadcrumbLink" RootLevel="0" Separator="&lt;img src=&quot;/portals/_default/Skins/Xcillion_DichVuCong/Images/breadcrumb-arrow.png&quot;&gt;" HideWithNoBreadCrumb="true" />
            </div>  
